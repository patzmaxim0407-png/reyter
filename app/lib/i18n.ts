...
const uk = {
  ...
  'p.note2': 'Доставка білизни по Україні <em>безкоштовна</em> від {free} грн при оплаті 100%',
  ...
  'acc.friendly': 'Friendly Club',
  'cart.emailLocked': 'Пошта вашого акаунта — до неї привʼязані замовлення й бали програми.',
  'cart.loyalty': 'Знижка учасника',
  'cart.loyaltyCap': 'Разом зі знижками діє межа магазину, тому знижку учасника зменшено.',
  'fc.shelf': 'Тільки для Friendly Club',
  'fc.shelfNote': 'Товари, яких немає у відкритому каталозі. Ви бачите їх, бо ви в клубі.',
  'fc.terms': 'Умови програми',
  'fc.title': 'Програма лояльності REYTER',
  'fc.pitch': 'Кожна покупка дає бали: одна гривня — один бал. Бали відкривають рівні, а рівень — постійну знижку на все. З третього рівня відкривається Friendly Club: закриті товари й ранній доступ до запусків.',
  'fc.past': 'Минулі замовлення з {date} теж рахуються — ми зарахуємо їх одразу після вступу.',
  'fc.join': 'Вступити в програму',
  'fc.joining': 'Хвилинку…',
  'fc.guest': 'Увійдіть в акаунт, щоб приєднатися до програми лояльності.',
  'fc.level': 'Рівень',
  'fc.points': 'балів',
  'fc.need': 'До {lvl} рівня лишилось {n} балів',
  'fc.till': 'Накопичити треба до {date}',
  'fc.noClock': 'Відлік почнеться з наступного замовлення.',
  'fc.top': 'Ви на найвищому рівні — знижка з вами назавжди.',
  'fc.inClub': 'Ви у Friendly Club',
  'fc.needInsta': 'Ви у Friendly Club — доступ уже ваш. Лишилось вказати Instagram, щоб ми знали, кого відмічати й до кого писати.',
  'fc.insta': 'Ваш Instagram',
  'fc.instaBad': 'Схоже на помилку в логіні. Тільки латиниця, крапки й підкреслення.',
  'fc.openClub': 'Зберегти',
  'fc.number': 'Ваш номер учасника',
  'fc.pending': 'Бали за минулі замовлення зарахуються найближчим часом.',
  'fc.joined': 'Вітаємо в програмі лояльності!',
  'fc.opened': 'Записали, дякуємо',
  'fc.failed': 'Не вдалося — спробуйте ще раз',
  ...
  'promo.usedUp': 'Ви вже скористалися цим кодом ({n} раз). Він працює один раз на покупця.',
  'promo.membersOnly': 'Код лише для учасників програми лояльності — вступити можна в кабінеті.',
  'promo.wrongLevel': 'Цей код не діє на вашому рівні програми лояльності.',
  ...
  'st.packingHint': 'Накладну створено — передаємо посилку на Нову Пошту',
...
const en: Record<UIKey, string> = {
  ...
  'p.note2': 'Underwear delivery within Ukraine is <em>free</em> on orders over UAH {free} with full prepayment',
  ...
  'promo.stUsed': 'Used',
  'acc.friendly': 'Friendly Club',
  'cart.emailLocked': 'Your account email — orders and loyalty points are tied to it.',
  'cart.loyalty': 'Member discount',
  'cart.loyaltyCap': 'Total discounts are capped, so the member discount was reduced.',
  'fc.shelf': 'Friendly Club only',
  'fc.shelfNote': 'Items that are not in the open catalogue. You see them because you are in the club.',
  'fc.terms': 'Programme terms',
  'fc.title': 'REYTER loyalty programme',
  'fc.pitch': 'Every purchase earns points: one hryvnia — one point. Points unlock levels, and a level gives a permanent discount on everything. From level 3 the Friendly Club opens: private items and early access to drops.',
  'fc.past': 'Past orders from {date} count too — we will credit them right after you join.',
  'fc.join': 'Join the programme',
  'fc.joining': 'One moment…',
  'fc.guest': 'Sign in to join the loyalty programme.',
  'fc.level': 'Level',
  'fc.points': 'points',
  'fc.need': '{n} points to level {lvl}',
  'fc.till': 'Collect them by {date}',
  'fc.noClock': 'The countdown starts with your next order.',
  'fc.top': 'You are at the top level — the discount stays with you for good.',
  'fc.inClub': 'You are in the Friendly Club',
  'fc.needInsta': 'You are in the Friendly Club — the access is already yours. All that is left is your Instagram, so we know who to tag and where to write.',
  'fc.insta': 'Your Instagram',
  'fc.instaBad': 'That looks off. Latin letters, dots and underscores only.',
  'fc.openClub': 'Save',
  'fc.number': 'Your member number',
  'fc.pending': 'Points for past orders will be credited shortly.',
  'fc.joined': 'Welcome to the loyalty programme!',
  'fc.opened': 'Saved, thank you',
  'fc.failed': 'Something went wrong — please try again',
  ...
  'promo.usedUp': 'You have already used this code ({n} time(s)). It works once per customer.',
  'promo.membersOnly': 'This code is for loyalty programme members only.',
  'promo.wrongLevel': 'This code does not apply at your loyalty level.',
  ...
  'st.packingHint': 'The waybill is ready — we are handing the parcel to the carrier',
