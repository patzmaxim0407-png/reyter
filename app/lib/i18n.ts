...
const uk = {
  ...
  'fc.pitch': 'Кожна покупка дає бали: одна гривня — один бал. Бали відкривають рівні, а рівень — постійну знижку на все. З третього рівня відчиняється Friendly Club: закриті товари й ранній доступ до запусків.',
  ...
  'fc.needInsta': 'Ваш рівень відкрив Friendly Club. Вкажіть Instagram — і ми відкриємо закриті товари та кликатимемо на запуски першими.',
  'fc.insta': 'Ваш Instagram',
  'fc.instaBad': 'Схоже на помилку в логіні. Тільки латиниця, крапки й підкреслення.',
  'fc.openClub': 'Відкрити Friendly Club',
  ...
  'fc.opened': 'Friendly Club відкрито',
...
const en: Record<UIKey, string> = {
  ...
  'fc.needInsta': 'Your level has opened the Friendly Club. Add your Instagram — we will unlock private items and invite you to drops first.',
  'fc.insta': 'Your Instagram',
  'fc.instaBad': 'That looks off. Latin letters, dots and underscores only.',
  'fc.openClub': 'Open the Friendly Club',
  ...
  'fc.opened': 'Friendly Club unlocked',
