...
const uk = {
  ...
  'dlv.intlText': 'Надсилаємо замовлення по всьому світу — <strong>Nova Global</strong> або <strong>Meest</strong>, за повної оплати',
...
const en: Record<UIKey, string> = {
  ...
  'dlv.intlText': 'We ship worldwide — <strong>Nova Global</strong> or <strong>Meest</strong>, with full prepayment',
