...
const uk = {
  ...
  'nav.drop': 'New drop&ensp;·&ensp;20.08',
  ...
  'addr.intlBranchHint': 'Оберіть пункт Nova Post — вулиця й індекс тоді не потрібні. У великих містах пунктів тисячі, тож найпевніше шукати за номером.',
  'addr.pudo': 'пункт видачі',
  'addr.localPhone': 'Для видачі за кордоном потрібен місцевий номер телефону отримувача — український приймають лише у власних відділеннях Nova Post.',
...
const en: Record<UIKey, string> = {
  ...
  'addr.intlBranchHint': 'Pick a Nova Post point — no street or postcode needed then. Big cities have thousands, so searching by number is the surest way.',
