...
const uk = {
  ...
  'fc.pitch': 'Кожна покупка дає бали: одна гривня — один бал. Бали відкривають рівні, а рівень — постійну знижку на все, назавжди.',
  ...
  'fc.needInsta': 'Лишіть свій Instagram — так ми знатимемо, кого відмічати й до кого писати. У Friendly Club ми запрошуємо самі, дивлячись не лише на покупки.',
  'fc.insta': 'Ваш Instagram (необовʼязково)',
...
const en: Record<UIKey, string> = {
  ...
  'fc.pitch': 'Every purchase earns points: one hryvnia — one point. Points unlock levels, and a level gives a permanent discount on everything, for good.',
  ...
  'fc.needInsta': 'Leave your Instagram so we know who to tag and where to write. We invite people to the Friendly Club ourselves, looking at more than purchases.',
  'fc.insta': 'Your Instagram (optional)',
