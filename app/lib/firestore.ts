 ...
 *
 *  Це число вирішує не «як часто читаємо базу», а «як часто
 *  воркер перемальовує сторінку» — і воно найкоротше з усіх, тож
 *  саме воно й перемагає. Доки тут стояло 60, сторінки протухали
 *  щохвилини, хоч у самих сторінках уже було виставлено 300: на
 *  безкоштовному тарифі Cloudflare кожне таке перемальовування —
 *  це виклик на 35-50 мс у бюджеті 10 мс, тобто приречений.
 *
 *  Публікація з адмінки від цього не сповільнилась: 5 хвилин — це
 *  все ще «поки менеджер допише опис у другій картці». */
