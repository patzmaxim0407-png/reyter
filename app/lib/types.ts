...
export interface Product {
  ...
  model?: string;
  notes?: string[];
  /** Примітки-картки під кнопкою «Додати в кошик».
   *
   *  Порожньо — працюють спільні для магазину (доставка, поріг
   *  безкоштовної, міжнародна). Власні потрібні там, де спільні
   *  брешуть: «доставка БІЛИЗНИ безкоштовна» на свічці чи сорочці
   *  читається як обіцянка, якої ніхто не давав.
   *
   *  {free} у тексті підставляється порогом із налаштувань. */
  cards?: string[];
