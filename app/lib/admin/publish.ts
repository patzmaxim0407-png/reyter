...
export function draftDiffers(
  ...
  /* Товари звіряємо за вмістом, а не за порядком у масиві.
     ...
     порядком. */
  /* Собівартість у порівнянні не бере участі.

     В опублікованому каталозі її немає навмисно — її зрізає
     публікація. Якби чернетку звіряли разом із нею, різниця була
     б завжди, і кнопка «Опублікувати» світилася б вічно:
     опублікуєш, оновиш сторінку — а вона знову горить. Рівно ця
     помилка вже була з закритими товарами клубу, і повторювати
     її вдруге не варто.

     Змінити ціну закупівлі — не привід публікувати каталог: у
     сайті від цього не міняється нічого. */
