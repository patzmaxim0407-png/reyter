...
export function buildOrder(input: {
  ...
  const order: Order = {
    ...
    /* Сума — це те, що покупець має заплатити магазину. Коли він
       ...
       ВХОДИТЬ; коли платить у відділенні — ні, і тоді shipping
       дорівнює нулю, а ціна лежить у shippingNote.

       Колись тут стояло «доставка в суму не входить ніколи» — це
       був обхід правил бази, які приймали лише «сума = товари −
       знижка». Правила давно приймають обидва вигляди, а обхід
       лишався: менеджер бачив у картці доставку 540 грн і «до
       сплати 2190», тобто рахунок, за яким магазин недоотримав
       би саме ці 540. */
