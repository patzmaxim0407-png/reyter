...
console.log('\nКАТЕГОРІЯ');
{
  /* Категорія — частина випуску, а не налаштування екрана: без
     неї при поверненні поради рахувались би по всьому каталогу,
     і три ціни щоразу виходили б інші. */
  const r: Release = { ...base, category: 'briefs' };
  ok('категорія живе в самому випуску', r.category === 'briefs');
  ok('план від неї не залежить', planOf(r).units === planOf(base).units);
}
