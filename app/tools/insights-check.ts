...
console.log('\nПІДСУМКИ');
{
  ...
  /* R-4 «Відправлено» на 5000: не виконане, не скасоване. Саме
     через такі замовлення виручка тут менша, ніж сума в архіві,
     і саме тому їх видно окремим числом, а не мовчки. */
  ok('у роботі — окремо від виручки й від скасованих',
     k.pending === 1 && k.pendingSum === 5000, k.pending + ' / ' + k.pendingSum);
