...

{
  ...
  ok('доставка, якої немає в сумі, ловиться',
     mk({ subtotal: 1000, discount: 0, shipping: 100, total: 1000 }) !== '');
  ...
  const gap = mk({ subtotal: 1000, discount: 0, shipping: 100, total: 1000 });
  ok('у тексті видно, що саме розійшлося', has(gap, '1 100', '1 000'), gap);
}
