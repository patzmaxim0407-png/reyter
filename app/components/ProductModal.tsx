...
export default function ProductModal({
   ...
   *
   *  Правило одне для всіх: чужа адреса — картки немає. Воно
   *  прибирає одразу дві біди. Перша: при зміні кольору на
   *  сторінці, відкритій за прямим посиланням, поверх старої
   *  картки лягала нова від перехопленого маршруту. Друга: після
   *  закриття Next лишає в слоті останнє показане, бо на каталозі
   *  тому слотові нема з чим збігтися, — картка зникала з очей,
   *  але не з розмітки. */
  selfPath?: string;
}) {
