    ...
    <>
      ...
      <div className="a-page">
        ...
        <div className="a-orders a-orders--page">
          ...
          {/* НЕ «Виручка». Так було, і поруч, в «Аналітиці», під тим
              самим словом стояло інше число — менше на доставку й
              на незавершені замовлення. Два різні показники під
              одним іменем читаються як помилка в одному з них, і
              власник іде шукати, котрий бреше; не бреше жоден.

              Тут — усе, що має пройти через касу за цими
              замовленнями: разом із незавершеними й разом із
              доставкою, яку покупець платить нам, а ми
              перевізникові. Це не заробіток, і слово «виручка»
              лишається аналітиці. */}
          <div className="ao-sum">
            ...
            <span>
              Сума замовлень: <b>{fmt(stats.revenue)} грн</b>
              <i className="ao-sum__hint">без скасованих, із доставкою</i>
            </span>
            <span>
