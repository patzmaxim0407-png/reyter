      ...
      <div className="a-modal__panel">
        ...
        <div className="a-editor">
          <form className="a-form" noValidate onSubmit={(e) => e.preventDefault()}>
            ...
            <p className="field__hint">
              Такий товар публікується <b>в окремий документ</b>, куди правила бази пускають лише
              учасників клубу. У відкритому каталозі його немає зовсім — ні в розмітці сторінок,
              ні в карті сайту, ні у відповіді для стороннього браузера. Хто не в клубі, той його
              не побачить і не купить: рахунок на такий товар банк теж не виставить.
            </p>
