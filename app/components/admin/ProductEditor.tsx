          ...
          <form className="a-form" noValidate onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="a-grid-2">
              <div className="field">
                ...
                <p className="field__hint">
                  Тільки для аналітики: у каталог на сайт не потрапляє. Змінюйте вільно —
                  у виконаних замовленнях собівартість зафіксована на момент продажу, і звіти
                  за минулі місяці від правки не змінюються.
                  {p.cost && p.price ? (
                    <>
