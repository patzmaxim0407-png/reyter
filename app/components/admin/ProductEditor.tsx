      ...
      <div className="a-modal__panel">
        ...
        <div className="a-editor">
          <form className="a-form" noValidate onSubmit={(e) => e.preventDefault()}>
            ...
            {/* «Сховати» сильніше: якщо стоять обидва прапорці,
                товару не бачить ніхто, зокрема й клуб. */}
            <label className="a-check">
              <input
                type="checkbox"
                checked={!!p.friendly}
            ...
            <p className="field__hint">
              У відкритому каталозі такого товару немає — його бачать лише учасники з третього
              рівня, з позначкою Friendly. У карту сайту він не потрапляє, тож і пошуковики його
              не знайдуть. Але це закритість від очей, а не від рук: опублікований каталог
              читається браузером цілком, і той, хто вміє дивитись у мережеві запити, товар
              побачить. Для раннього доступу цього досить; для таємниці — ні.
            </p>
