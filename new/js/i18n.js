...
(function () {
  ...
  const UI = {
    uk: {
      ...
      'contacts.sub': 'Ми завжди на звʼязку. Обирайте зручний спосіб — відповімо швидко та допоможемо з будь-яким питанням.',
      ...
      'p.writeManager': 'Написати менеджеру',
      'p.orderNote': 'Замовлення приймаємо в Instagram Direct — відповімо швидко 💙',
      'p.fabric': 'Тканина',
      'p.material': 'Склад',
      'p.aroma': 'Аромат',
      ...
      'cart.submit': 'Сформувати замовлення',
      'cart.submitNote': 'Замовлення надсилається нам в Instagram Direct',
      'cart.fillNamePhone': 'Заповніть імʼя та телефон',
      'cart.checkEmail': 'Перевірте email',
      'cart.doneTitle': 'сформовано!',
      'cart.doneText': 'Залишився один крок: надішліть його нам в Instagram Direct — текст уже скопійовано, просто вставте його в повідомлення.',
      'cart.doneMail': 'Підтвердження з номером замовлення надіслано на',
      'cart.openIg': 'Відкрити Instagram',
      'cart.copyAgain': 'Скопіювати ще раз',
      ...
      'acc.ordersNote': 'Замовлення з вашого акаунта. Статус уточнюйте в Instagram Direct.',
      'acc.ordersLocalNote': 'Історія зберігається у вашому браузері. Статус замовлення уточнюйте в Instagram Direct.',
    ...
    en: {
      ...
      'contacts.sub': 'We are always in touch. Choose whatever suits you — we reply fast and help with any question.',
      ...
      'p.writeManager': 'Message us',
      'p.orderNote': 'We take orders via Instagram Direct — we reply fast 💙',
      'p.fabric': 'Fabric',
      ...
      'cart.submit': 'Create order',
      'cart.submitNote': 'Your order is sent to us via Instagram Direct',
      'cart.fillNamePhone': 'Please fill in your name and phone',
      'cart.checkEmail': 'Please check your email',
      'cart.doneTitle': 'created!',
      'cart.doneText': 'One step left: send it to us on Instagram Direct — the text is already copied, just paste it into a message.',
      'cart.doneMail': 'A confirmation with your order number has been sent to',
      'cart.openIg': 'Open Instagram',
      'cart.copyAgain': 'Copy again',
      'cart.copied': 'Copied ✓',
      'cart.order': 'Order',
      ...
      'acc.ordersNote': 'Orders from your account. For status details, message us on Instagram Direct.',
      'acc.ordersLocalNote': 'History is stored in this browser. For status details, message us on Instagram Direct.',
