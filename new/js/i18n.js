...
(function () {
  ...
  const UI = {
    uk: {
      ...
      'promo.notFoundGuest': 'Такого промокоду не існує. Якщо код персональний — увійдіть в акаунт, для якого його видано',
      'promo.notYours': 'Це персональний промокод для {email} — увійдіть у цей акаунт',
      ...
      'promo.notFound': 'Такого промокоду не існує — перевірте написання',
      ...
      'promo.exhausted': 'Промокод вичерпано — усі використання вже витрачені',
      'promo.minTotal': 'Промокод діє від {min} — додайте товарів ще на {need}',
      'promo.noItems': 'Промокод не діє на товари у вашому кошику',
    ...
    en: {
      ...
      'promo.notFoundGuest': 'No such promo code. If it is a personal code — sign in to the account it was issued for',
      'promo.notYours': 'This is a personal promo code for {email} — sign in to that account',
      ...
      'promo.notFound': 'No such promo code — please check the spelling',
      ...
      'promo.exhausted': 'This promo code has been fully used',
      'promo.minTotal': 'Valid from {min} — add {need} more to your cart',
      'promo.noItems': 'This promo code does not apply to items in your cart',
